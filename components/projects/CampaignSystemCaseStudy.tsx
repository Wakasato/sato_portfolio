  ...
  return (
    <div className="bg-background min-h-screen text-foreground">
      <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24 flex flex-col gap-16">
        ...
        <section className="flex flex-wrap gap-x-8 gap-y-2 -mt-8 text-sm">
          <div>
            ...
            <span className="text-muted ml-2">Product Designer</span>
          </div>

          <div>
            <span className="font-semibold text-foreground">Company:</span>
            <span className="text-muted ml-2">HR Tech</span>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4">
          <h3 className="font-display text-sm font-semibold text-muted uppercase tracking-[0.2em]">Impact &amp; Outcomes</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border-y border-border divide-x divide-border py-6 my-2">
            <div className="flex flex-col px-6 gap-1">
              <span className="font-display text-3xl font-medium text-accent">£200k</span>
              <span className="text-xs text-muted font-medium uppercase leading-tight">quarterly revenue uplift</span>
            </div>
            <div className="flex flex-col px-6 gap-1">
              <span className="font-display text-3xl font-medium text-accent">Zero</span>
              <span className="text-xs text-muted font-medium uppercase leading-tight">incidents across all releases</span>
            </div>
            <div className="flex flex-col px-6 gap-1">
              <span className="font-display text-3xl font-medium text-accent">4x</span>
              <span className="text-xs text-muted font-medium uppercase leading-tight">promotion frequency increase</span>
            </div>
            <div className="flex flex-col px-6 gap-1">
              <span className="font-display text-3xl font-medium text-accent">25%</span>
              <span className="text-xs text-muted font-medium uppercase leading-tight">reduction in operational effort</span>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-8">
          <h3 className="font-display text-sm font-semibold text-muted uppercase tracking-[0.2em] border-b border-border pb-4">My Role: Senior Product Designer / UX Lead</h3>

          <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
            {/* CSS Stakeholder Map (Quarter Circle Design) */}
            <div className="relative w-full max-w-[400px] aspect-square shrink-0 rounded-tr-[100%] overflow-hidden border border-border bg-background">
              {/* Background Concentric Layers */}
              <div className="absolute bottom-0 left-0 w-full h-full bg-surface rounded-tr-[100%] transition-transform"></div>
              <div className="absolute bottom-0 left-0 w-[85%] h-[85%] bg-background rounded-tr-[100%]"></div>
              <div className="absolute bottom-0 left-0 w-[65%] h-[65%] bg-surface rounded-tr-[100%]"></div>
              <div className="absolute bottom-0 left-0 w-[45%] h-[45%] bg-border/40 rounded-tr-[100%]"></div>

              {/* Layer Labels */}
              <span className="absolute bottom-[75%] left-[5%] font-semibold text-foreground text-lg opacity-80">Campaign<br />Team</span>
              <span className="absolute bottom-[20%] left-[45%] font-semibold text-muted text-sm opacity-80 tracking-wider">WELBOX</span>
              <span className="absolute bottom-[5%] left-[70%] font-semibold text-muted text-sm tracking-wider">WELBOX Users</span>

              {/* Connecting Lines (SVG) */}
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
                {/* Director center is approx at x=100, y=300 */}
                <g className="stroke-border" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round">
                  {/* To Design Team */}
              ...
              {/* Nodes */}
              {/* Director (Me) */}
              <div className="absolute bottom-[20%] left-[20%] -translate-x-1/2 translate-y-1/2 w-20 h-20 bg-accent rounded-full flex flex-col items-center justify-center text-accent-foreground font-semibold text-sm z-10 leading-tight border-2 border-background">
                Director<br /><span className="font-normal text-xs opacity-80">(Me)</span>
              </div>

              {/* Inner Layer Nodes (Campaign Team) */}
              <div className="absolute bottom-[6%] left-[8%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-foreground rounded-full flex flex-col items-center justify-center text-background font-semibold text-[11px] leading-tight border border-foreground/80">
              ...
              <div className="absolute bottom-[48%] left-[12%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-foreground rounded-full flex flex-col items-center justify-center text-background font-semibold text-[11px] leading-tight border border-foreground/80">
              ...
              <div className="absolute bottom-[38%] left-[36%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-foreground rounded-full flex flex-col items-center justify-center text-background font-semibold text-[11px] leading-tight border border-foreground/80">
                <svg className="w-6 h-6 mb-0.5 opacity-80" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path></svg>
                Sales<br />Team
              </div>

              {/* Middle Layer Nodes (WELBOX) */}
              <div className="absolute bottom-[65%] left-[24%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-muted rounded-full flex flex-col items-center justify-center text-background font-semibold text-[11px] leading-tight border border-muted">
              ...
              <div className="absolute bottom-[6%] left-[55%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-muted rounded-full flex flex-col items-center justify-center text-background font-semibold text-[11px] leading-tight border border-muted">
                <svg className="w-6 h-6 mb-0.5 opacity-80" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path></svg>
                Back<br />Office
              </div>

              {/* Outer Layer Nodes (External) */}
              <div className="absolute bottom-[50%] left-[50%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-background rounded-full flex flex-col items-center justify-center text-foreground font-semibold text-[11px] leading-tight border border-border">
              ...
              <div className="absolute bottom-[20%] left-[88%] -translate-x-1/2 translate-y-1/2 w-16 h-16 bg-background rounded-full flex flex-col items-center justify-center text-foreground font-semibold text-[11px] leading-tight border border-border">
                <svg className="w-6 h-6 mb-0.5 opacity-80" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path></svg>
                Employee
              </div>
            </div>
        ...
        {/* Problem */}
        <section className="flex flex-col gap-6">
          <h3 className="font-display text-sm font-semibold text-muted uppercase tracking-[0.2em]">Problem</h3>
          ...
          <div className="w-full max-w-2xl mx-auto mt-2 overflow-hidden border border-border bg-surface">
            <img
          ...
          <div className="flex flex-col gap-6 mt-4">
            ...
            <div className="flex flex-col gap-4 p-6 border border-border bg-surface">
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full border border-border text-foreground text-sm font-semibold shrink-0 font-mono">
                  1
                </span>
              ...
              <div className="flex flex-col gap-3 text-muted text-sm leading-relaxed pl-11 max-w-3xl">
                <p>
            ...
            {/* Decision 3 */}
            <div className="flex flex-col gap-6 p-6 border border-border bg-surface">
              <div className="flex items-start gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full border border-border text-foreground text-sm font-semibold shrink-0 font-mono">
                  3
                </span>
              ...
              <div className="flex flex-col gap-6 pl-11">
                <div className="flex flex-col gap-3 text-muted text-sm leading-relaxed max-w-3xl">
                  <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2 w-full">
                  ...
                  <div className="border border-border bg-background p-4">
                    <div
                      className="relative overflow-hidden bg-surface cursor-zoom-in transition-transform hover:scale-[1.02]"
                    ...
                    <p className="text-xs text-muted mt-3 font-semibold">Before: Manual workflow bottleneck</p>
                  </div>
                  ...
                  <div className="border border-border bg-background p-4">
                    ...
                    <p className="text-xs text-muted mt-3 font-semibold">After: Unified campaign system</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="flex flex-col gap-8 mb-16">
          <h3 className="font-display text-sm font-semibold text-muted uppercase tracking-[0.2em] border-b border-border pb-4">Design Process</h3>

          <div className="flex flex-col gap-8">
            {/* Flowchart Diagram */}
            <div className="flex flex-col md:flex-row items-center gap-4 w-full bg-surface p-6 border border-border">
              ...
              <div className="flex flex-col items-center gap-2 flex-1 text-center">
                ...
                <span className="font-semibold text-xs uppercase tracking-wide text-muted">Workflow Analysis</span>
              </div>
              ...
              {/* Step 2 */}
              <div className="flex flex-col items-center gap-2 flex-1 text-center">
                <div className="w-16 h-16 bg-background border border-border flex items-center justify-center font-mono text-xl text-muted font-semibold">
                  &lt;JS&gt;
                </div>
                <span className="font-semibold text-xs uppercase tracking-wide text-muted">Internal Tooling</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 flex-1 text-center">
                <div className="w-16 h-16 bg-background border border-border flex items-center justify-center">
                  <svg className="w-8 h-8 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                </div>
                <span className="font-semibold text-xs uppercase tracking-wide text-muted">Validation &amp; Research</span>
              </div>
              ...
              {/* Step 4 */}
              <div className="flex flex-col items-center gap-2 flex-1 text-center">
                <div className="w-16 h-16 bg-background border border-accent flex items-center justify-center">
                  <svg className="w-8 h-8 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <span className="font-semibold text-xs uppercase tracking-wide text-accent">UX Redesign</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 text-sm">
              <div className="flex flex-col gap-2">
                <h5 className="font-semibold text-foreground">Workflow Analysis</h5>
                <p className="text-muted">Identified manual data registration as a major operational bottleneck.</p>
              </div>
              <div className="flex flex-col gap-2">
                <h5 className="font-semibold text-foreground">Internal Tooling Improvement</h5>
                <p className="text-muted">Built a lightweight JavaScript tool that converted Excel inputs into JSON and HTML.</p>
              </div>
              <div className="flex flex-col gap-2 md:col-span-2">
                <h5 className="font-semibold text-foreground">Validation &amp; Research</h5>
                <p className="text-muted">Conducted a 10,000+ user survey to identify unmet needs, revealing strong demand for sales campaigns.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Reflection */}
        <section className="flex flex-col gap-8 mb-16">
          <h3 className="font-display text-sm font-semibold text-muted uppercase tracking-[0.2em] border-b border-border pb-4">Reflection</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
              <h4 className="font-semibold text-foreground text-base">Designing Beyond the Interface</h4>
              <ul className="list-disc list-inside text-sm text-muted space-y-2 marker:text-accent">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="font-semibold text-foreground text-base">Working Within Constraints</h4>
              <ul className="list-disc list-inside text-sm text-muted space-y-2 marker:text-accent">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="font-semibold text-foreground text-base">Operational Reliability Over Feature Expansion</h4>
              <ul className="list-disc list-inside text-sm text-muted space-y-2 marker:text-accent">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="font-semibold text-foreground text-base">Communication as a Design Tool</h4>
              <ul className="list-disc list-inside text-sm text-muted space-y-2 marker:text-accent">
      ...
      {modalImage && (
        ...
        >
          <img src={modalImage} alt="Fullscreen View" className="max-w-full max-h-[90vh] object-contain" />
        </div>
      )}
    </div>
  );
